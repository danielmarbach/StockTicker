//-------------------------------------------------------------------------------
// <copyright file="RangeToTextConverterTest.cs" company="bbv Software Services AG">
//   Copyright (c) 2012
//
...
namespace StockTicker.ManageStocks
{
    ...
    public class RangeToTextConverterTest
    {
        ...
        public void ShouldConvertRange(decimal @from, decimal to, string expected)
        {
            ...
            result.As<string>().Should().NotBeNull().And.Be(expected);
        }

        private class RangeData : IEnumerable<object[]>
        {
